...
RUN wget https://developer.arm.com/-/media/Files/downloads/gnu/12.2.mpacbti-bet1/binrel/arm-gnu-toolchain-12.2.mpacbti-bet1-x86_64-arm-none-eabi.tar.xz -P /tmp --progress=bar:force
RUN tar -C /tmp -xf /tmp/arm-gnu-toolchain-12.2.mpacbti-bet1-x86_64-arm-none-eabi.tar.xz
RUN mv /tmp/arm-gnu-toolchain-12.2.mpacbti-bet1-x86_64-arm-none-eabi /opt/gcc-arm-none-eabi
RUN rm /tmp/arm-gnu-toolchain-12.2.mpacbti-bet1-x86_64-arm-none-eabi.tar.xz
